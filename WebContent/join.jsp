		...
		<section class="page" id="page1">
			...
			2) 시행일자 : 2018년 05월 01일 
						...
						<div class="btn_fr">
							...
							<lable for="ck_item2">개인정보 수집에 대한 동의</lable><br><br>
							<button type="button" id="in_btn1" class="btn btn-parimary">다음 단계</button>
						</div>
						<script>
						var ck_item1 = document.getElementById("ck_item1");
						var ck_item1 = document.getElementById("ck_item1");
						var ck_item1 = document.getElementById("in_item1");
						...
						function idCheck(){
							...
							if(id.value!=""){
								window.open("idCheck.jsp?id="+id.value,"아이디 중복 검사")
							}else {
								alert("아이디를 입력해주세요");
								id.focus();
								return;
